...
## <b>XSPI_NOR_MemoryMapped XSPI memory mapped mode example Example Description</b>
...
Memory, map, XSPI, Erase, section, sector, memory-mapped mode, TrustZone disabled

### <b>Directory contents</b>

  - XSPI/XSPI_NOR_MemoryMapped/Inc/stm32u3xx_hal_conf.h HAL configuration file
  - XSPI/XSPI_NOR_MemoryMapped/Inc/stm32u3xx_it.h       Interrupt handlers header file
  - XSPI/XSPI_NOR_MemoryMapped/Inc/main.h               Header for main.c module
  - XSPI/XSPI_NOR_MemoryMapped/Src/stm32u3xx_it.c       Interrupt handlers
  - XSPI/XSPI_NOR_MemoryMapped/Src/main.c               Main program
  - XSPI/XSPI_NOR_MemoryMapped/Src/system_stm32u3xx.c   STM32U3xx system source file
  - XSPI/XSPI_NOR_MemoryMapped/Src/stm32u3xx_hal_msp.c  HAL MSP file
