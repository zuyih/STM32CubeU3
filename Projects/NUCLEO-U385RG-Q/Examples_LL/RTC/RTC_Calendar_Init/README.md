...
The RTC is in the backup (BKP) domain. If the LSE is enabled, even after a reset
...
2. If the default clock LSI is enabled, when a reset (except power on reset) occurs the BKP domain is not reset and the RTC 
...
### <b>Directory contents</b>
  ...
  - RTC/RTC_Calendar_Init/Inc/stm32u3xx_it.h          Interrupt handlers header file
  ...
  - RTC/RTC_Calendar_Init/Src/stm32u3xx_it.c          Interrupt handlers
  - RTC/RTC_Calendar_Init/Src/main.c                  Main program
  - RTC/RTC_Calendar_Init/Src/system_stm32u3xx.c      STM32U3xx system source file
