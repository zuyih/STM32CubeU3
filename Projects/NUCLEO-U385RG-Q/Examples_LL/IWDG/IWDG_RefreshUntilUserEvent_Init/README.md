...
LD2 is blinking fast & continuously.
...
RCC IWDG Reset Flag will be checked and if we are back from a IWDG reset the LD2
will be switch ON.
...
### <b>Directory contents</b>
  ...
  - IWDG/IWDG_RefreshUntilUserEvent_Init/Inc/stm32u3xx_it.h          Interrupt handlers header file
  ...
  - IWDG/IWDG_RefreshUntilUserEvent_Init/Src/stm32u3xx_it.c          Interrupt handlers
  - IWDG/IWDG_RefreshUntilUserEvent_Init/Src/main.c                        Main program
  - IWDG/IWDG_RefreshUntilUserEvent_Init/Src/system_stm32u3xx.c      STM32U3xx system source file
