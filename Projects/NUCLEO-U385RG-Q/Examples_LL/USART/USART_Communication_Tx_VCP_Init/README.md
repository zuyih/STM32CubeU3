...
with a Timeout error code. This example is based on STM32U3xx USART LL API. Peripheral
...
At completion of Tx Buffer sending, LD2 is turned On.
...
### <b>Directory contents</b>
  ...
  - USART/USART_Communication_Tx_VCP_Init/Inc/stm32u3xx_it.h          Interrupt handlers header file
  ...
  - USART/USART_Communication_Tx_VCP_Init/Src/stm32u3xx_it.c          Interrupt handlers
  - USART/USART_Communication_Tx_VCP_Init/Src/main.c                  Main program
  - USART/USART_Communication_Tx_VCP_Init/Src/system_stm32u3xx.c      STM32U3xx system source file
