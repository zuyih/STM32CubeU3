...
After startup from reset and system configuration, LD2 is blinking quickly.
...
Data processing consists in echoing data buffer content on PC Com port, and making LD2 toggle.
...
### <b>Directory contents</b>
  ...
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Inc/stm32u3xx_it.h          Interrupt handlers header file
  ...
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Src/stm32u3xx_it.c          Interrupt handlers
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Src/main.c                  Main program
  - USART/USART_Communication_Rx_IT_Continuous_VCP_Init/Src/system_stm32u3xx.c      STM32U3xx system source file
