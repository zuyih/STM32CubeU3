...
void SPI2_IRQHandler(void)
{
  ...
  /* Check TXP flag value in ISR register */
  else if (LL_SPI_IsActiveFlag_TXP(SPI2) && LL_SPI_IsEnabledIT_TXP(SPI2))
  {
    /* Call function Reception Callback */
    SPI2_Tx_Callback();
    return;
  ...
  /* Check CRCERR/UDR flag value in ISR register */
  else if (LL_SPI_IsActiveFlag_OVR(SPI2) || LL_SPI_IsActiveFlag_UDR(SPI2))
  {
    /* Call Error function */
    SPI2_TransferError_Callback();
  }
  /* Check EOT flag value in ISR register */
  else if (LL_SPI_IsActiveFlag_EOT(SPI2) && LL_SPI_IsEnabledIT_EOT(SPI2))
  {
    /* Call function Reception Callback */
    SPI2_EOT_Callback();
    return;
