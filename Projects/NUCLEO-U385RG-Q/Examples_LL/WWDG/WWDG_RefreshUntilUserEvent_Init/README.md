...
- LD2 is blinking fastly & continuously

Example Execution:

When User push-button is pressed, the Downcounter automatic refresh mechanism is disable and thus, reset will occur.
After a reset when re-entering in the main, RCC WWDG Reset Flag will be checked and if we are back from a WWDG reset the LD2 will be switch ON.
...
### <b>Directory contents</b>
  ...
  - WWDG/WWDG_RefreshUntilUserEvent_Init/Inc/stm32u3xx_it.h          Interrupt handlers header file
  ...
  - WWDG/WWDG_RefreshUntilUserEvent_Init/Src/stm32u3xx_it.c          Interrupt handlers
  - WWDG/WWDG_RefreshUntilUserEvent_Init/Src/main.c                  Main program
  - WWDG/WWDG_RefreshUntilUserEvent_Init/Src/system_stm32u3xx.c      STM32U3xx system source file
