...
/**
  ...
  *          HSI as source clock through the STM32U3xx UTILS LL API.
  ******************************************************************************
  * @attention
  *
...
void LED_Init(void)
{
  /* Enable the LD2 Clock */
  LD2_GPIO_CLK_ENABLE();

  /* Configure IO in output push-pull mode to drive external LD2 */
