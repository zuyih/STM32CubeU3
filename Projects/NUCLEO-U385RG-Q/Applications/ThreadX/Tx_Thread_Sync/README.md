...
Each thread is running in an infinite loop as follows:
...
#### <b>Expected success behavior</b>
  ...
  - Messages on HyperTerminal :
     ...
     + "** ThreadXXX : SyncObject released **" : When thread puts the SyncObject.
     + "** ThreadXXX : SyncObject acquired **" : When thread gets the SyncObject.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics NUCLEO-U385RG boards revision: MB1841-U385RGQ-D01
