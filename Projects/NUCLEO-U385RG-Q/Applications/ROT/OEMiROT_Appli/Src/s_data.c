...
{
  uint8_t *data1;
  data1 = (uint8_t*)(FLASH_BASE_S + S_DATA_IMAGE_PRIMARY_PARTITION_OFFSET + BL2_DATA_HEADER_SIZE);

  printf("  -- S Data: %08lx%08lx..%08lx%08lx\r\n\n",
               *((unsigned long *)(&data1[0])),
               *((unsigned long *)(&data1[4])),
               *((unsigned long *)(&data1[BL2_DATA_HEADER_SIZE - 8])),
               *((unsigned long *)(&data1[BL2_DATA_HEADER_SIZE - 4]))
              );
}
