...
#define NS_DATA_IMAGE_DATA_OFFSET          (BL2_DATA_HEADER_SIZE)
#define NS_DATA_IMAGE_DATA_SIZE            (32U)
...
{
  uint8_t *data1;
  data1 = (uint8_t*)(FLASH_BASE_NS + NS_DATA_IMAGE_PRIMARY_PARTITION_OFFSET + NS_DATA_IMAGE_DATA_OFFSET);

  printf("  -- NS Data: %08lx%08lx..%08lx%08lx\r\n\n",
               *((unsigned long *)(&data1[0])),
               *((unsigned long *)(&data1[4])),
               *((unsigned long *)(&data1[NS_DATA_IMAGE_DATA_SIZE - 8])),
               *((unsigned long *)(&data1[NS_DATA_IMAGE_DATA_SIZE - 4]))
              );
}
