...
OPENBL_MemoryTypeDef RAM_ALIAS_Descriptor =
{
  RAM_ALIAS_START_ADDRESS + OPENBL_RAM_ALIAS_SIZE, /* OPENBL_RAM_ALIAS_SIZE is added to protect the Open Bootloader
                                                      RAM alias area */
  RAM_ALIAS_END_ADDRESS,
  RAM_ALIAS_SIZE,
  RAM_ALIAS_AREA,
  OPENBL_RAM_Read,
  OPENBL_RAM_Write,
