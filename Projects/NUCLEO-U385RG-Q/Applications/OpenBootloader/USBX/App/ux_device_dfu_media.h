...
UINT DFU_Read(void *p_dfu, ULONG block_number, UCHAR *p_data, ULONG length, ULONG *p_media_status);
UINT DFU_Write(void *p_dfu, ULONG block_number, UCHAR *p_data, ULONG length, ULONG *media_status);

UINT DFU_Device_ConnectionCallback(ULONG device_state);
void DFU_Activate(void *p_dfu_instance);
void DFU_Deactivate(void *p_dfu_instance);
