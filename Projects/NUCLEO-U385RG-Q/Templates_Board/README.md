...
This project provides a reference template for the NUCLEO-U385RG-Q board based on the STM32Cube HAL API and the
...
This template shows how to use the BSP drivers for the leds, user push-button and VCP COM port of the NUCLEO-U385RG-Q
