...
How to handle a SPI as a Master to perform a data buffer transmission/reception in 
autonomous mode between two boards, using DMA in autonomous mode.
...
If the Slave board is used, the project SPI_FullDuplex_ComDMA_Autonomous_Slave must be used.
...
### <b>Directory contents</b>
  ...
  - SPI/SPI_FullDuplex_ComDMA_Autonomous_Master/Inc/stm32u3xx_nucleo_conf.h     BSP configuration file
  - SPI/SPI_FullDuplex_ComDMA_Autonomous_Master/Inc/stm32u3xx_hal_conf.h   HAL configuration file
  - SPI/SPI_FullDuplex_ComDMA_Autonomous_Master/Inc/stm32u3xx_it.h         Interrupt handlers header file
  - SPI/SPI_FullDuplex_ComDMA_Autonomous_Master/Inc/main.h                 Header for main.c module
  - SPI/SPI_FullDuplex_ComDMA_Autonomous_Master/Src/stm32u3xx_it.c         Interrupt handlers
  - SPI/SPI_FullDuplex_ComDMA_Autonomous_Master/Src/main.c                 Main program
  - SPI/SPI_FullDuplex_ComDMA_Autonomous_Master/Src/system_stm32u3xx.c     stm32u3xx system source file
  - SPI/SPI_FullDuplex_ComDMA_Autonomous_Master/Src/stm32u3xx_hal_msp.c    HAL MSP file
