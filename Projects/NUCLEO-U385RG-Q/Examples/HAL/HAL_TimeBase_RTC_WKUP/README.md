...
This implementation will overwrite native implementation in stm32u3xx_hal.c
...
In an infinite loop, LD2 toggles spaced out over 500ms delay, except when tick increment is suspended.
...
### <b>Directory contents</b>
  ...
  - HAL/HAL_TimeBase_RTC_WKUP/Inc/stm32u3xx_nucleo_conf.h     BSP configuration file
  - HAL/HAL_TimeBase_RTC_WKUP/Inc/stm32u3xx_hal_conf.h                HAL configuration file
  - HAL/HAL_TimeBase_RTC_WKUP/Inc/stm32u3xx_it.h                      Interrupt handlers header file
  - HAL/HAL_TimeBase_RTC_WKUP/Inc/main.h                                    Header for main.c module  
  - HAL/HAL_TimeBase_RTC_WKUP/Src/stm32u3xx_it.c                      Interrupt handlers
  - HAL/HAL_TimeBase_RTC_WKUP/Src/main.c                                    Main program
  - HAL/HAL_TimeBase_RTC_WKUP/Src/stm32u3xx_hal_msp.c                 HAL MSP file
  - HAL/HAL_TimeBase_RTC_WKUP/Src/stm32u3xx_hal_timebase_rtc_wakeup.c HAL time base functions
  - HAL/HAL_TimeBase_RTC_WKUP/Src/system_stm32u3xx.c                  STM32U3xx system source file

### <b>Hardware and Software environment</b> 

  - This example runs on STM32U385RGTxQ devices.
    
  - This example has been tested with STMicroelectronics NUCLEO-U385RG-Q board and can be
