...
The example unrolls as follows:
 ...
 - an AES GCM low-priority message processing is suspended due to the interruption by a high priority messages CMAC processing.   
...
When all ciphering and deciphering operations are successful, (LD2) is turned on.
In case of ciphering or deciphering issue, (LD2) is blinking.  
...
### <b>Directory contents</b>
  ...
  - CRYP/CRYP_SAES_WrapKey/Inc/stm32u3xx_nucleo_conf.h    BSP Configuration file
  - CRYP/CRYP_GCM_GMAC_CMAC_Suspension/Inc/stm32u3xx_hal_conf.h    HAL configuration file
  - CRYP/CRYP_GCM_GMAC_CMAC_Suspension/Inc/stm32u3xx_it.h          Interrupt handlers header file
  - CRYP/CRYP_GCM_GMAC_CMAC_Suspension/Inc/main.h                  Header for main.c module
  - CRYP/CRYP_GCM_GMAC_CMAC_Suspension/Src/stm32u3xx_it.c          Interrupt handlers
  - CRYP/CRYP_GCM_GMAC_CMAC_Suspension/Src/main.c                  Main program
  - CRYP/CRYP_GCM_GMAC_CMAC_Suspension/Src/stm32u3xx_hal_msp.c     HAL MSP module
  - CRYP/CRYP_GCM_GMAC_CMAC_Suspension/Src/system_stm32u3xx.c      STM32U3xx system source file
