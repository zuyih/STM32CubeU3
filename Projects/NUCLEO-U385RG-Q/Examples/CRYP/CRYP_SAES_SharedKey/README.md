...
In this example, LD2 (led GREEN) is turned on when the operation finish with success . 
and LD2 (led GREEN) is toggling when the operation generate an error.
...
### <b>Directory contents</b>
  ...
  - CRYP/CRYP_SAES_SharedKey/Inc/stm32u3xx_nucleo_conf.h    BSP configuration file
  - CRYP/CRYP_SAES_SharedKey/Src/main.c                         Main program
  - CRYP/CRYP_SAES_SharedKey/Src/system_stm32u3xx.c       STM32U3xx system clock configuration file
  - CRYP/CRYP_SAES_SharedKey/Src/stm32u3xx_it.c           Interrupt handlers
  - CRYP/CRYP_SAES_SharedKey/Src/stm32u3xx_hal_msp.c      HAL MSP module
  - CRYP/CRYP_SAES_SharedKey/Inc/main.h                         Main program header file
  - CRYP/CRYP_SAES_SharedKey/Inc/stm32u3xx_hal_conf.h     HAL Configuration file
  - CRYP/CRYP_SAES_SharedKey/Inc/stm32u3xx_it.h           Interrupt handlers header file
