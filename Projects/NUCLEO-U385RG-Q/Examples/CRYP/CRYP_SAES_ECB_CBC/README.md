...
Finally, LD2 (led green) is turned on if all encrypted/decrypted are as expected and
LD2 (led green) is toggling when the operation generates an error or when the ciphering
...
### <b>Directory contents</b>
  ...
  - CRYP/CRYP_SAES_ECB_CBC/Inc/stm32u3xx_nucleo_conf.h    BSP configuration file
  - CRYP/CRYP_SAES_ECB_CBC/Inc/stm32u3xx_hal_conf.h    HAL configuration file
  - CRYP/CRYP_SAES_ECB_CBC/Inc/stm32u3xx_it.h          Interrupt handlers header file
  - CRYP/CRYP_SAES_ECB_CBC/Inc/main.h                  Header for main.c module
  - CRYP/CRYP_SAES_ECB_CBC/Src/stm32u3xx_it.c          Interrupt handlers
  - CRYP/CRYP_SAES_ECB_CBC/Src/main.c                  Main program
  - CRYP/CRYP_SAES_ECB_CBC/Src/stm32u3xx_hal_msp.c     HAL MSP module
  - CRYP/CRYP_SAES_ECB_CBC/Src/system_stm32u3xx.c      STM32U3xx system source file
