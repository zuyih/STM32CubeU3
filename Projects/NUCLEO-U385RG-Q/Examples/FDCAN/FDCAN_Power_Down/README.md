...
This example describes the FDCAN operation in power-down mode.
...
The example is divided into several sections:<br>
  ...
  - In section 4, the application tries to send an FDCAN message, and checks that it remains pending until power down mode is exited.
...
NUCLEO-U385RG-Q's LEDs can be used to monitor the transfer status:
  ...
  - LD2 is ON when all messages were successfully transmitted and received.
...
File | Description
 --- | ---
FDCAN/FDCAN_Power_Down/Inc/stm32u3xx_nucleo_conf.h    | BSP configuration file
FDCAN/FDCAN_Power_Down/Inc/stm32u3xx_hal_conf.h   | HAL configuration file
FDCAN/FDCAN_Power_Down/Inc/stm32u3xx_it.h         | Header for stm32u3xx_it.c
FDCAN/FDCAN_Power_Down/Inc/main.h                 | Header for main.c module
FDCAN/FDCAN_Power_Down/Src/stm32u3xx_it.c         | Interrupt handlers
FDCAN/FDCAN_Power_Down/Src/main.c                 | Main program
FDCAN/FDCAN_Power_Down/Src/stm32u3xx_hal_msp.c    | HAL MSP module
FDCAN/FDCAN_Power_Down/Src/system_stm32u3xx.c     | stm32u3xx system source file
