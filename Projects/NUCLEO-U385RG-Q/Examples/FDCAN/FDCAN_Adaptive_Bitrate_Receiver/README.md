...
The example is divided into several steps:<br>
  ...
  - In the first step, the *HAL_FDCAN_Init()* function is called to configure the bitrate to try to receive the message from the transmitter board.<br>
    ...
    If all bitrates were tested and no message was received, the application ends and LD2 blinks.<br>
  ...
  - If the result is OK, the application ends and LD2 stays ON.
  - If the transmitter bitrate was not found, or the message is not correctly received, or if at any time of the process an error is encountered, LD2 starts blinking.
...
NUCLEO-U385RG-Q's LEDs can be used to monitor the transfer status:
  ...
  - LD2 is ON when the expected bitrate is found as expected and acknowledge message is transmitted.
...
File | Description
 --- | ---
FDCAN/FDCAN_Adaptive_Bitrate_Receiver/Inc/stm32u3xx_nucleo_conf.h    | BSP configuration file
FDCAN/FDCAN_Adaptive_Bitrate_Receiver/Inc/stm32u3xx_hal_conf.h   | HAL configuration file
FDCAN/FDCAN_Adaptive_Bitrate_Receiver/Inc/stm32u3xx_it.h         | Header for stm32u3xx_it.c
FDCAN/FDCAN_Adaptive_Bitrate_Receiver/Inc/main.h                 | Header for main.c module
FDCAN/FDCAN_Adaptive_Bitrate_Receiver/Src/stm32u3xx_it.c         | Interrupt handlers
FDCAN/FDCAN_Adaptive_Bitrate_Receiver/Src/main.c                 | Main program
FDCAN/FDCAN_Adaptive_Bitrate_Receiver/Src/stm32u3xx_hal_msp.c    | HAL MSP module
FDCAN/FDCAN_Adaptive_Bitrate_Receiver/Src/system_stm32u3xx.c     | stm32u3xx system source file
