...
The example is divided into several steps:<br>
  ...
  - If an acknowledge message was received, the application ends and LD2 stays ON.
...
NUCLEO-U385RG-Q's LEDs can be used to monitor the transfer status:
  ...
  - LD2 is ON when the acknowledge message is received as expected.
...
File | Description
 --- | ---
FDCAN/FDCAN_Adaptive_Bitrate_Transmitter/Inc/stm32u3xx_nucleo_conf.h    | BSP configuration file
FDCAN/FDCAN_Adaptive_Bitrate_Transmitter/Inc/stm32u3xx_hal_conf.h   | HAL configuration file
FDCAN/FDCAN_Adaptive_Bitrate_Transmitter/Inc/stm32u3xx_it.h         | Header for stm32u3xx_it.c
FDCAN/FDCAN_Adaptive_Bitrate_Transmitter/Inc/main.h                 | Header for main.c module
FDCAN/FDCAN_Adaptive_Bitrate_Transmitter/Src/stm32u3xx_it.c         | Interrupt handlers
FDCAN/FDCAN_Adaptive_Bitrate_Transmitter/Src/main.c                 | Main program
FDCAN/FDCAN_Adaptive_Bitrate_Transmitter/Src/stm32u3xx_hal_msp.c    | HAL MSP module
FDCAN/FDCAN_Adaptive_Bitrate_Transmitter/Src/system_stm32u3xx.c     | stm32u3xx system source file
