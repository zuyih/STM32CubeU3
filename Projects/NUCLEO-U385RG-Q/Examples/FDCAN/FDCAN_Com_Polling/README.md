...
The example is divided into several steps:<br>
  ...
  - In the first step, the *HAL_FDCAN_Init()* function is called to configure the module with a **Nominal Bit Rate of 1 MBit/s** and a **sampling point at 75%**.<br>
    Additionally, it has a **Data Bit Rate of 8 MBit/s** and a **sampling point at 75%**.<br>
  ...
  - When User push-button is pressed on any board, its LD2 is turned OFF and its FDCAN module sends a message with Bit Rate Switching.
  - On the other board, after polling for message reception in the main loop, received payload is compared to expected data. If the result is OK, LD2 is turned ON.
...
File | Description
 --- | ---
FDCAN/FDCAN_Com_Polling/Inc/stm32u3xx_nucleo_conf.h    | BSP configuration file
FDCAN/FDCAN_Com_Polling/Inc/stm32u3xx_hal_conf.h   | HAL configuration file
FDCAN/FDCAN_Com_Polling/Inc/stm32u3xx_it.h         | Header for stm32u3xx_it.c
FDCAN/FDCAN_Com_Polling/Inc/main.h                 | Header for main.c module
FDCAN/FDCAN_Com_Polling/Src/stm32u3xx_it.c         | Interrupt handlers
FDCAN/FDCAN_Com_Polling/Src/main.c                 | Main program
FDCAN/FDCAN_Com_Polling/Src/stm32u3xx_hal_msp.c    | HAL MSP module
FDCAN/FDCAN_Com_Polling/Src/system_stm32u3xx.c     | stm32u3xx system source file
