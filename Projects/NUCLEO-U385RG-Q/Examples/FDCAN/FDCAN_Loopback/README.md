...
NUCLEO-U385RG-Q's LEDs can be used to monitor the transfer status:
  ...
  - LD2 is ON when all three messages were successfully transmitted and received.
...
File | Description
 --- | ---
FDCAN/FDCAN_Loopback/Inc/stm32u3xx_nucleo_conf.h    | BSP configuration file
FDCAN/FDCAN_Loopback/Inc/stm32u3xx_hal_conf.h   | HAL configuration file
FDCAN/FDCAN_Loopback/Inc/stm32u3xx_it.h         | Header for stm32u3xx_it.c
FDCAN/FDCAN_Loopback/Inc/main.h                 | Header for main.c module
FDCAN/FDCAN_Loopback/Src/stm32u3xx_it.c         | Interrupt handlers
FDCAN/FDCAN_Loopback/Src/main.c                 | Main program
FDCAN/FDCAN_Loopback/Src/stm32u3xx_hal_msp.c    | HAL MSP module
FDCAN/FDCAN_Loopback/Src/system_stm32u3xx.c     | stm32u3xx system source file
