## <b>SAI_AudioRecord_PDM Example Description</b>

  This project demonstrates how to configure SAI to perform PDM record in DMA circular mode.
...
Audio, SAI, DMA, PDM, PCM

### <b>Directory contents</b>

	- SAI/SAI_AudioRecord_PDM/Src/main.c                   Main program
	- SAI/SAI_AudioRecord_PDM/Src/system_stm32u3xx.c       STM32U3xx system clock configuration file
	- SAI/SAI_AudioRecord_PDM/Src/stm32u3xx_it.c           Interrupt handlers
	- SAI/SAI_AudioRecord_PDM/Src/stm32u3xx_hal_msp.c      HAL MSP module
	- SAI/SAI_AudioRecord_PDM/Inc/main.h                   Main program header file
	- SAI/SAI_AudioRecord_PDM/Inc/stm32u3xx_nucleo_conf.h  BSP Configuration file
	- SAI/SAI_AudioRecord_PDM/Inc/stm32u3xx_hal_conf.h     HAL Configuration file
	- SAI/SAI_AudioRecord_PDM/Inc/stm32u3xx_it.h           Interrupt handlers header file
