...
with different Hide Protection (HDP) properties:
          ...
          126 |___________________________________| 0x0C07E000
              |                                   |
              |                                   |
              .                                   .
              |                                   |
...
file is as follows:
 ...
 - TZEN=1
 - Bank 1 watermark :
   - SECWM1R1 : STRT=0x00  END=0x7F  meaning all pages of Flash bank 1 set as secured
   - SECWM1R2 : END=0x0E  EN=0x01  meaning HDP area includes pages 0 to 15 of Flash bank 1
 - Bank 2 watermark :
   - SECWM2R1 : STRT=0x7F  END=0x00  meaning all pages of Flash bank 2 set as non-secured
 - Boot addresses :
   - SBOOT0 : 0x0C000000 to set secure VTOR
   - BOOT0 : 0x08080000 to set non-secure VTOR


Any attempt by the non-secure application to access unauthorized code, memory or
peripheral generates a fault.

The NUCLEO-U385RG-Q board LED can be used to monitor the transfer status:

  - LED2 is ON when there is an issue during erase or program procedure
  - LED2 is blinking when there are no errors detected
  - LED2 is blinking (100ms on, 2s off) when there is an issue during programmed data check or
...
File | Description
 --- | ---
  ...
  FLASH/FLASH_HideProtection_TrustZone/Secure/Src/stm32u3xx_hal_msp.c        |  Secure HAL MSP module
  FLASH/FLASH_HideProtection_TrustZone/Secure/Src/stm32u3xx_it.c             |  Secure Interrupt handlers
  FLASH/FLASH_HideProtection_TrustZone/Secure/Src/system_stm32u3xx_s.c       |  Secure STM32U3xx system init file
  FLASH/FLASH_HideProtection_TrustZone/Secure/Inc/main.h                     |  Secure Main program header file
  FLASH/FLASH_HideProtection_TrustZone/Secure/Inc/partition_stm32u385xx.h    |  Secure core configuration file
  FLASH/FLASH_HideProtection_TrustZone/Inc/stm32u3xx_hal_conf.h              |  Secure HAL configuration file
  FLASH/FLASH_HideProtection_TrustZone/Secure/Inc/stm32u3xx_it.h             |  Secure Interrupt handlers header file
  FLASH/FLASH_HideProtection_TrustZone/Secure/Inc/stm32u3xx_nucleo_conf.h    |  Secure BSP configuration file
  ...
  FLASH/FLASH_HideProtection_TrustZone/NonSecure/Src/stm32u3xx_hal_msp.c     |  Non-secure HAL MSP module
  FLASH/FLASH_HideProtection_TrustZone/NonSecure/Src/stm32u3xx_it.c          |  Non-secure Interrupt handlers
  FLASH/FLASH_HideProtection_TrustZone/NonSecure/Src/system_stm32u3xx_ns.c   |  Non-secure STM32U3xx system init file
  FLASH/FLASH_HideProtection_TrustZone/NonSecure/Inc/main.h                  |  Non-secure Main program header file
  FLASH/FLASH_HideProtection_TrustZone/NonSecure/Inc/stm32u3xx_hal_conf.h    |  Non-secure HAL Configuration file
  FLASH/FLASH_HideProtection_TrustZone/NonSecure/Inc/stm32u3xx_it.h          |  Non-secure Interrupt handlers header file
  FLASH/FLASH_HideProtection_TrustZone/NonSecure/Inc/stm32u3xx_nucleo_conf.h |  Non-secure BSP configuration file


### <b>Hardware and Software environment</b>

  - This example runs on STM32U385RGx devices with security enabled (TZEN=1).
...
Option Byte | Value | Description
 --- | --- | ---
  ...
  BOOT0R_ADD        | 0x08080000 | BOOT0 address for non-secure automatic VTOR update 
  SECWM1R1_STRT     | 0x00       | All pages of Flash bank 1 set as secured
  SECMW1R1_END      | 0x7F       | All pages of Flash bank 1 set as secured
  SECWM1R2_HDP1_END | 0x0E       | HDP area from page 0 to 15 of Flash bank 1
  SECWM1R2_HDP1EN   | 0x01       | HDP area enabled in Flash bank 1
  SECWM2R1_STRT     | 0x7F       | All pages of Flash bank 2 set as non-secured
  SECWM2R1_END      | 0x00       | All pages of Flash bank 2 set as non-secured
