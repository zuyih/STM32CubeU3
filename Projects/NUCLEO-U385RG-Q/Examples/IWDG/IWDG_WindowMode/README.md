...
LD2 is also toggled each 450 ms indicating that the program is running.

LD2 will turn off if any error occurs.
...
If the IWDG reset is generated, after the system resumes from reset, LD2 turns on for 4 seconds.
...
### <b>Directory contents</b>
  ...
  - IWDG/IWDG_WindowMode/Inc/stm32u3xx_nucleo_conf.h     BSP configuration file
  - IWDG/IWDG_WindowMode/Inc/stm32u3xx_hal_conf.h    HAL configuration file
  - IWDG/IWDG_WindowMode/Inc/stm32u3xx_it.h          Interrupt handlers header file
  - IWDG/IWDG_WindowMode/Inc/main.h                  Header for main.c module
  - IWDG/IWDG_WindowMode/Src/stm32u3xx_it.c          Interrupt handlers
  - IWDG/IWDG_WindowMode/Src/main.c                  Main program
  - IWDG/IWDG_WindowMode/Src/system_stm32u3xx.c      STM32U3xx system source file
