...
STM32 board LED is used to monitor the example status:
  ...
  - LD2 is ON when the correct CCB value is calculated
  - LD2 is slowly blinking (1 sec. period) when there is an error in initialization or if an incorrect CCB value is calculated.
...
### <b>Directory contents</b>
  ...
  - CCB/CCB_Protected_ECCScalarMul_BlobCreation/Inc/stm32u3xx_nucleo_conf.h     BSP configuration file
  - CCB/CCB_Protected_ECCScalarMul_BlobCreation/Inc/stm32u3xx_hal_conf.h        HAL configuration file
  - CCB/CCB_Protected_ECCScalarMul_BlobCreation/Inc/stm32u3xx_it.h              Interrupt handlers header file
  - CCB/CCB_Protected_ECCScalarMul_BlobCreation/Inc/main.h                      Header for main.c module
  - CCB/CCB_Protected_ECCScalarMul_BlobCreation/Src/stm32u3xx_it.c              Interrupt handlers
  - CCB/CCB_Protected_ECCScalarMul_BlobCreation/Src/main.c                      Main program
  - CCB/CCB_Protected_ECCScalarMul_BlobCreation/Src/stm32u3xx_hal_msp.c         HAL MSP module
  - CCB/CCB_Protected_ECCScalarMul_BlobCreation/Src/system_stm32u3xx.c          STM32U3xx system source file
