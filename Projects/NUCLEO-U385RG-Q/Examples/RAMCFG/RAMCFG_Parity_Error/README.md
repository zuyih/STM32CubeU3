...
The example performs the following actions:
 ...
 1. First, enable parity detection feature with SRAM2_PE bit inside FLASH_OPTR.
    LD2 toggles 10 times at 100 ms to indicate the software step.
...
There are 3 different read access types at several SRAM2 addresses that can chose to be performed or not with ArraySRAMParityError array:
 ...
 - Parity Error generated @ 0x20034128 on byte position 2 with CPU read access.

 - Parity Error generated @ 0x20030004 on byte position 4 with DMA read access with port 0.

 - Parity Error generated @ 0x2003FFFC on byte position 1 with DMA read access with port 1.

NUCLEO-U385RG-Q board's LED can be used to monitor the project operation status:
 - LD2 toggles 10 times at 100 ms to indicate each software step.
...
### <b>Directory contents</b>
  ...
  - RAMCFG/RAMCFG_ParityError/Src/system_stm32u3xx.c           STM32U3xx system clock configuration file
  - RAMCFG/RAMCFG_ParityError/Src/stm32u3xx_it.c               Interrupt handlers
  - RAMCFG/RAMCFG_ParityError/Src/stm32u3xx_hal_msp.c          HAL MSP module
  - RAMCFG/RAMCFG_ParityError/Inc/main.h                        Main program header file
  - RAMCFG/RAMCFG_ParityError/Inc/stm32u3xx_hal_conf.h         HAL Configuration file
  - RAMCFG/RAMCFG_ParityError/Inc/stm32u3xx_it.h               Interrupt handlers header file
  - RAMCFG/RAMCFG_ParityError/Inc/stm32u3xx_nucleo_conf.h      HAL configuration file
