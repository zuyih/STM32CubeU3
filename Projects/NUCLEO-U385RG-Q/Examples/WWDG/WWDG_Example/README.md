...
**LD2** is toggling at same frequency, indicating that the program is running.
...
If the WWDG reset is generated, after the system resumes from reset, **LD2** is turned ON for 4 seconds.
...
**LD2** is turned OFF if any error occurs.
...
### <b>Directory contents</b>
  ...
  - WWDG/WWDG_Example/Inc/stm32u3xx_nucleo_conf.h     BSP configuration file
  - WWDG/WWDG_Example/Inc/stm32u3xx_hal_conf.h    HAL configuration file
  - WWDG/WWDG_Example/Inc/stm32u3xx_it.h          Interrupt handlers header file
  - WWDG/WWDG_Example/Inc/main.h                        Header for main.c module
  - WWDG/WWDG_Example/Src/stm32u3xx_it.c          Interrupt handlers
  - WWDG/WWDG_Example/Src/main.c                        Main program
  - WWDG/WWDG_Example/Src/stm32u3xx_hal_msp.c     HAL MSP file
  - WWDG/WWDG_Example/Src/system_stm32u3xx.c      STM32U3xx system source file
