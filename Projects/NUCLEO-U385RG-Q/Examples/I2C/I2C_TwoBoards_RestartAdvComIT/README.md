...
Slave board side only :
 ...
 - LD2 is turned ON when the reception process is completed.

Master board side only :

 - LD2 is turned ON when the transmission process is completed.

Both sides :

 - LD2 is slowly blinking (1 sec. period) when there is an error in communication process.(communication is stopped if any, using infinite loop)
...
NUCLEO-U385RG-Q board's LEDs can be used to monitor the transfer status in both sides :

Slave board side :

 - LD2 is turned ON when the reception process is completed.
 - LD2 is turned OFF when the transmission process is completed.

Master board side :

 - LD2 is turned ON when the transmission process is completed.
 - LD2 is turned OFF when the reception process is completed.
...
### <b>Directory contents</b>
  ...
  - I2C/I2C_TwoBoards_RestartAdvComIT/Inc/stm32u3xx_nucleo_conf.h     BSP configuration file
  - I2C/I2C_TwoBoards_RestartAdvComIT/Inc/stm32u3xx_hal_conf.h    HAL configuration file
  - I2C/I2C_TwoBoards_RestartAdvComIT/Inc/stm32u3xx_it.h          I2C interrupt handlers header file
  - I2C/I2C_TwoBoards_RestartAdvComIT/Inc/main.h                  Header for main.c module
  - I2C/I2C_TwoBoards_RestartAdvComIT/Src/stm32u3xx_it.c          I2C interrupt handlers
  - I2C/I2C_TwoBoards_RestartAdvComIT/Src/main.c                  Main program
  - I2C/I2C_TwoBoards_RestartAdvComIT/Src/system_stm32u3xx.c      STM32U3xx system source file
  - I2C/I2C_TwoBoards_RestartAdvComIT/Src/stm32u3xx_hal_msp.c     HAL MSP file
