...
LD2 is turned ON when the RTC Alarm is generated correctly.
The current time is updated and displayed on the debugger in aShowTime variable.
In case of error, LD2 is toggled with a period of one second.
...
### <b>Directory contents</b>
  ...
  - RTC/RTC_Alarm/Inc/stm32u3xx_nucleo_conf.h     BSP configuration file
  - RTC/RTC_Alarm/Inc/stm32u3xx_hal_conf.h    HAL configuration file
  - RTC/RTC_Alarm/Inc/stm32u3xx_it.h          Interrupt handlers header file
  - RTC/RTC_Alarm/Inc/main.h                  Header for main.c module  
  - RTC/RTC_Alarm/Src/stm32u3xx_it.c          Interrupt handlers
  - RTC/RTC_Alarm/Src/main.c                  Main program
  - RTC/RTC_Alarm/Src/stm32u3xx_hal_msp.c     HAL MSP module
  - RTC/RTC_Alarm/Src/system_stm32u3xx.c      STM32U3xx system source file
