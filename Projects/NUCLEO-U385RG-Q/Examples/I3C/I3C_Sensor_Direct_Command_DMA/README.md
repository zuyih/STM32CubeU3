...
How to handle a Direct Command procedure between STM32U3xx Nucleo and X-NUCLEO-IKS4A1,
using DMA.
...
### <b>Directory contents</b>
  ...
  - I3C/I3C_Sensor_Direct_Command_DMA/Inc/stm32u3xx_nucleo_conf.h   BSP configuration file
  - I3C/I3C_Sensor_Direct_Command_DMA/Inc/stm32u3xx_hal_conf.h      HAL configuration file
  - I3C/I3C_Sensor_Direct_Command_DMA/Inc/stm32u3xx_it.h            I3C interrupt handlers header file
  - I3C/I3C_Sensor_Direct_Command_DMA/Inc/main.h                    Header for main.c module
  - I3C/I3C_Sensor_Direct_Command_DMA/Src/stm32u3xx_it.c            I3C interrupt handlers
  - I3C/I3C_Sensor_Direct_Command_DMA/Src/main.c                    Main program
  - I3C/I3C_Sensor_Direct_Command_DMA/Src/system_stm32u3xx.c        STM32U3xx system source file
  - I3C/I3C_Sensor_Direct_Command_DMA/Src/stm32u3xx_hal_msp.c       HAL MSP file
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-U385RG-Q up to Rev D Set-up
    ...
    - Plug a X-NUCLEO-IKS4A1 (https://www.st.com/en/ecosystems/x-nucleo-iks4a1.html) expansion board
      ...
      - Then connect, by using short wire as possible or or twist an independent ground wire on each I3C lines
...
In order to make the program work, you must do the following:
 ...
 - Rebuild all files and load your image into Controller memory (I3C_Sensor_Direct_Command_DMA).
