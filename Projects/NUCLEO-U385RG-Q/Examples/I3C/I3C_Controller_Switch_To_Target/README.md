...
How to handle an I3C as a Controller to perform a Controller Role Request Direct Command procedure between an
I3C Controller and an I3C Target, using Interrupt.
...
NUCLEO-U385RG-Q's LEDs can be used to monitor the transfer status:
 ...
 - LD2 is toggle at ENTDAA reception and Controller Role Request process is completed.
 - LD2 is toggle slowly when there is an error in ENTDAA and Controller Roler Request process.
...
### <b>Directory contents</b>
  ...
  - I3C/I3C_Controller_Switch_To_Target/Inc/stm32u3xx_nucleo_conf.h   BSP configuration file
  - I3C/I3C_Controller_Switch_To_Target/Inc/stm32u3xx_hal_conf.h      HAL configuration file
  - I3C/I3C_Controller_Switch_To_Target/Inc/stm32u3xx_it.h            I3C interrupt handlers header file
  - I3C/I3C_Controller_Switch_To_Target/Inc/main.h                    Header for main.c module
  - I3C/I3C_Controller_Switch_To_Target/Src/stm32u3xx_it.c            I3C interrupt handlers
  - I3C/I3C_Controller_Switch_To_Target/Src/main.c                    Main program
  - I3C/I3C_Controller_Switch_To_Target/Src/system_stm32u3xx.c        STM32U3xx system source file
  - I3C/I3C_Controller_Switch_To_Target/Src/stm32u3xx_hal_msp.c       HAL MSP file
