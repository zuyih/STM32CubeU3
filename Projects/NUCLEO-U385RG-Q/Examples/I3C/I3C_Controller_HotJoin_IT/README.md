...
How to handle an I3C as Target to perform a HOTJOIN procedure between an I3C Controller and I3C Targets,
using interrupt.
...
The communication run at 12.5Mhz during Push-pull phases based on I3C source clock which is at 96MHz.
...
NUCLEO-U385RG-Q's LEDs can be used to monitor the transfer status:
 ...
 - LD2 is toggle each time an HotJoin process is completed
...
### <b>Directory contents</b>
  ...
  - I3C/I3C_Controller_HotJoin_IT/Inc/stm32u3xx_nucleo_conf.h   BSP configuration file
  - I3C/I3C_Controller_HotJoin_IT/Inc/stm32u3xx_hal_conf.h      HAL configuration file
  - I3C/I3C_Controller_HotJoin_IT/Inc/stm32u3xx_it.h            I3C interrupt handlers header file
  - I3C/I3C_Controller_HotJoin_IT/Inc/main.h                    Header for main.c module
  - I3C/I3C_Controller_HotJoin_IT/Src/stm32u3xx_it.c            I3C interrupt handlers
  - I3C/I3C_Controller_HotJoin_IT/Src/main.c                    Main program
  - I3C/I3C_Controller_HotJoin_IT/Src/system_stm32u3xx.c        stm32u3xx system source file
  - I3C/I3C_Controller_HotJoin_IT/Src/stm32u3xx_hal_msp.c       HAL MSP file
