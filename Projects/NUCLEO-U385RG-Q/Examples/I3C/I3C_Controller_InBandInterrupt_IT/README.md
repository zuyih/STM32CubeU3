...
How to handle an I3C as a Controller to perform an In-Band-Interrupt event between an I3C Controller
and I3C Targets.

      - Board: NUCLEO-U385RG-Q's (embeds a STM32U3xx device)
      - SCL Pin: PA7 (Arduino D11 CN5 pin 4, Morpho CN10 pin15) to PA7 (Arduino D11 CN5 pin 4, Morpho CN10 pin15)
      - SDA Pin: PA6 (Arduino D12 CN5 pin 5, Morpho CN10 pin13) to PA6 (Arduino D12 CN5 pin 5, Morpho CN10 pin13)
...
NUCLEO-U385RG-Q's LEDs can be used to monitor the transfer status:
 ...
 - LD2 is toggle each time an In-Band-Interrupt process is completed.
 - LD2 is toggle slowly when there is an error in In-Band-Interrupt process. .
...
### <b>Directory contents</b>
  ...
  - I3C/I3C_Controller_InBandInterrupt_IT/Inc/stm32u3xx_nucleo_conf.h   BSP configuration file
  - I3C/I3C_Controller_InBandInterrupt_IT/Inc/stm32u3xx_hal_conf.h      HAL configuration file
  - I3C/I3C_Controller_InBandInterrupt_IT/Inc/stm32u3xx_it.h            I3C interrupt handlers header file
  - I3C/I3C_Controller_InBandInterrupt_IT/Inc/main.h                    Header for main.c module
  - I3C/I3C_Controller_InBandInterrupt_IT/Src/stm32u3xx_it.c            I3C interrupt handlers
  - I3C/I3C_Controller_InBandInterrupt_IT/Src/main.c                    Main program
  - I3C/I3C_Controller_InBandInterrupt_IT/Src/system_stm32u3xx.c        stm32u3xx system source file
  - I3C/I3C_Controller_InBandInterrupt_IT/Src/stm32u3xx_hal_msp.c       HAL MSP file
