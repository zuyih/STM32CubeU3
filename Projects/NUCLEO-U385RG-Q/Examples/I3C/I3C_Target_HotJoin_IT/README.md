...
How to handle an I3C as Controller to perform a HOTJOIN procedure between an I3C Controller and I3C Targets,
using interrupt.
...
NUCLEO-U385RG-Q's LEDs can be used to monitor the transfer status:
 ...
 - LD2 is ON when the HotJoin and Dynamic Address Assignment process is complete.
 - LD2 is toggle slowly when there is an error in HotJoin or Dynamic Address Assignment process.
...
### <b>Directory contents</b>
  ...
  - I3C/I3C_Target_HotJoin_IT/Inc/stm32u3xx_nucleo_conf.h   BSP configuration file
  - I3C/I3C_Target_HotJoin_IT/Inc/stm32u3xx_hal_conf.h      HAL configuration file
  - I3C/I3C_Target_HotJoin_IT/Inc/stm32u3xx_it.h            I3C interrupt handlers header file
  - I3C/I3C_Target_HotJoin_IT/Inc/main.h                    Header for main.c module
  - I3C/I3C_Target_HotJoin_IT/Src/stm32u3xx_it.c            I3C interrupt handlers
  - I3C/I3C_Target_HotJoin_IT/Src/main.c                    Main program
  - I3C/I3C_Target_HotJoin_IT/Src/system_stm32u3xx.c        stm32u3xx system source file
  - I3C/I3C_Target_HotJoin_IT/Src/stm32u3xx_hal_msp.c       HAL MSP file
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-U385RG-Q Set-up
    ...
    - Use short wire as possible between the boards or twist an independent ground wire on each I3C lines
      mean one GND twist around SCL and one GND twist around SDA to help communication at 12.5Mhz.
    - Connect I3C_SCL line of Controller board (PA7 Arduino D11 CN5 pin 4, Morpho CN10 pin15) 
    to I3C_SCL line of Target Board (PA7 Arduino D11 CN5 pin 4, Morpho CN10 pin15).
    - Connect I3C_SDA line of Controller board (PA6 Arduino D12 CN5 pin 5, Morpho CN10 pin13) 
    to I3C_SDA line of Target Board (PA6 Arduino D12 CN5 pin 5, Morpho CN10 pin13).
