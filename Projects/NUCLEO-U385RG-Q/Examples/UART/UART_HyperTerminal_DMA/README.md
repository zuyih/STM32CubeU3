...
between a board and an HyperTerminal PC application.
    ...
    Tx Pin: PA9(available through VCP)
    Rx Pin: PA10(available through VCP)
...
NUCLEO-U385RG-Q board LED is used to monitor the transfer status:
 ...
 - LD2 turns OFF when when there is an error in transmission/reception process.
...
### <b>Directory contents</b>
  ...
  - UART/UART_HyperTerminal_DMA/Inc/stm32u3xx_nucleo_conf.h BSP configuration file
  - UART/UART_HyperTerminal_DMA/Inc/stm32u3xx_hal_conf.h    HAL configuration file
  - UART/UART_HyperTerminal_DMA/Inc/stm32u3xx_it.h          DMA interrupt handlers header file
  - UART/UART_HyperTerminal_DMA/Inc/main.h                   Header for main.c module
  - UART/UART_HyperTerminal_DMA/Src/stm32u3xx_it.c          DMA interrupt handlers
  - UART/UART_HyperTerminal_DMA/Src/main.c                   Main program
  - UART/UART_HyperTerminal_DMA/Src/stm32u3xx_hal_msp.c     HAL MSP module
  - UART/UART_HyperTerminal_DMA/Src/system_stm32u3xx.c      STM32U3xx system source file
