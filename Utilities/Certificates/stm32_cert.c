...
/* Offset for Template data DUA User (Free Usage and Licensed Usage) */
...
/* Data Template to complete the DUA User Free Usage certificate field */
...
/* Data Template to complete the DUA User Licensed Usage certificate field */
...
/* Offset in the system flash to retrieve dua user Free Usage certificate information */
...
/* Offset in the system flash to retrieve dua user Licensed Usage certificate information */
...
/**
  ...
  *                            - 1 : DUA user Free Usage
  *                            - 2 : DUA user Licensed Usage
